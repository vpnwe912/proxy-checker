...
| Команда | Описание |
|---------|----------|
| `make prepare` | Подготовка иконок приложения (assets-src/appicon.png → build/appicon.png, build/windows/icon.ico) |
